                ...
                <div key={index} className="mb-8 flex flex-wrap sm:justify-center md:justify-center lg:justify-center">
                    ...
                    <div className="w-full max-w-xl lg:w-3/4">
                        ...
                        {project.technologies.map((tech, index) =>(
                            <span key={index} className={`mr-2 overflow-auto whitespace-nowrap rounded border-2 border-slate-800 px-2 py-1 text-lg font-bold text-slate-800 ${DarkMode ? "text-white bg-purple-500 hover:bg-purple-200" : "text-slate-800 bg-blue-100 hover:bg-blue-300"}`}>{tech}
